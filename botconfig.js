module.exports = {
  ...
  Token:
    process.env.Token ||
    "OTQ1ODkwNTY0OTIwOTc5NDc3.YhWvPA.-m--Xc49vsSSbLyK9nMMadpoG2s", //Discord Bot Token
  ClientID: process.env.Discord_ClientID || "945890564920979477", //Discord Client ID
  ClientSecret:
    process.env.Discord_ClientSecret || "-mNDeZwedRFOpjVfLWarDI6stZb7WqlA", //Discord Client Secret
